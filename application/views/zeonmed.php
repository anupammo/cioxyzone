...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-xs-12">
            <figure>
              <figcaption>Zeon Medical</figcaption>
              <img class="img-responsive mid-block img-linux" src="<?php echo base_url(); ?>cntnt/img/ZEON-MEDICAL.jpg"
              alt="MODEL-NISA–P" title="OXYZONE THERAPY HEALTHCARE PRODUCT MODEL NISA–P">
            </figure>
          </div>
          <div class="col-md-1 col-xs-12"></div>
          <div class="col-md-4 col-xs-12">
            <h3 class="text-left text-uppercase h3-bold prd-head">Zeon Medical</h3>
            <hr class="hr-ozone hr-left" />
            <p class="text-justify p-testimoni">Analog medical ozone generator used by senior practitioners to train their students about the art of ozone
              therapy. An entry-level model, which is admired by our senior medical clients, due to its high-end class & quality at a pocket-friendly
              budget. This model can be used for most major medical ozone applications. Exported globally for best results in Auto-Haemo Therapy, Ozone
              Discolysis, Ozone Insufflations of blood, Dentistry, etc.</p>
          </div>
          <div class="col-md-1 col-xs-12"></div>
          <div class="col-xs-12">
    ...
    <section class="parallax-product-zeon">
      <div class="bgdark">
        <div class="container">
          <div class="row">
            <div class="col-xs-12">
              ...
              <ul class="txt-fff text-uppercase list-unstyled">
                ...
                <li>High Success Rates, certified by senior medical practitioners</li>
                <li>Perfect Calibration</li>
                <li>Tropical-Climate Compatible</li>
                <li>Multi-layer Pitted-through-hole PCB&#39;s</li>
                <li>Nominal Power Consumption</li>
                <li>Ozone Regulation as per treatment : 25-35 ug/ml, 35-40 ug/ml & 40-50 ug/ml</li>
                <li>Calibrated for usage with both Air and pure Oxygen</li>
              </ul>
            </div>
          </div>
        </div>
        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <ul class="text-uppercase list-unstyled">
              <li>Dimensions : 295X175X155 mm</li>
              <li>Weight : 5 Kg</li>
              <li>Medical Ozone : Upto 50 micrograms per ml (3 Regulator stages to change ozone dosage)</li>
              <li>Noise : 43 decibels</li>
              <li>Power Consumption : 77 Watts</li>
