...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-xs-12">
            <figure>
              <figcaption>MODEL 0019-GWP</figcaption>
              <img class="img-responsive mid-block img-linux" src="https://ozonepedia.com/oxyzonetherapy/images/stories/image002.jpg"
              alt="MODEL-NISA–P" title="OXYZONE THERAPY HEALTHCARE PRODUCT MODEL NISA–P">
            </figure>
          </div>
          <div class="col-md-1 col-xs-12"></div>
          <div class="col-md-4 col-xs-12">
            <h3 class="text-left text-uppercase h3-bold prd-head">Model 0019–GWP</h3>
            <hr class="hr-ozone hr-left" />
            <p class="text-justify p-testimoni">This is a Analog model, perfectly calibrated and adjustable from 7 to 98 micrograms
              per ml at 1 to 2 litres per minute medical oxygen feed. Popularly used for Ozone Discolysis, Autohaemotherapy, Cardiac dialysis,
              Rectal / ear / vaginal insufflation, ophthalmology and gynecology (with special attachments)</p>
          </div>
          <div class="col-md-1 col-xs-12"></div>
          <div class="col-xs-12">
    ...
    <section class="parallax-product-gwpone">
      <div class="bgdark">
        <div class="container">
          <div class="row">
            <div class="col-xs-12">
              <h3 class="text-left text-uppercase txt-fff h3-bold">Features</h3>
              <hr class="hr-left" />
              <ul class="txt-fff text-uppercase list-unstyled">
                <li>Analog model. Adjustment from 7 to 98 micrograms per ml.</li>
                ...
                <li>Admired for its heavy duty nature and user friendly interface.</li>
        ...
        <div class="row">
          <div class="col-xs-12">
            ...
            <ul class="text-uppercase list-unstyled">
              <li>Dimensions :	340 mm x 360 mm x 125 mm</li>
              <li>Power Consumption :	10 Watts, 220 Volts, 50 Hz per 1000 mg/hr.</li>
              <li>Ozone Production :	7 to 98 micrograms per litre.</li>
              <li>Recommended feed :	Medical grade oxygen</li>
              <li>Room Size that can be treated :	2,000 Cft approximately*</li>
              <li>Oxygen flow :	1 to 2 litres / min, dry and filtered</li>
              <li>Safety : Electrically intrinsically safe. Not recommended for direct inhalation. Should not be used continuosly in a closed room. Should
                use the support of timer provided.</li>
              <li>Environmental Issue :	No harmful byproduct.</li>
              <li>Special Feature :	Advanced models are available with Ozone sensor switches.</li>
