      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-xs-12">
            <figure>
              <figcaption>Model 0023–GWP</figcaption>
              <img class="img-responsive mid-block img-linux" src="<?php echo base_url(); ?>cntnt/img/0023-GWP.jpg"
              alt="MODEL-NISA–P" title="OXYZONE THERAPY HEALTHCARE PRODUCT MODEL NISA–P">
            </figure>
          </div>
          <div class="col-md-1 col-xs-12"></div>
          <div class="col-md-4 col-xs-12">
            <h3 class="text-left text-uppercase h3-bold prd-head">Model 0023–GWP</h3>
            <hr class="hr-ozone hr-left" />
            <p class="text-justify p-testimoni">This is a Digital model with real time on line calibration visible on screen. Used
              in all the above applications and in addition, applicable for chelation therapy along with EDTA, toxicity removal, treatment of cancer and AIDS.
              Microprocessor controlled, self cooled design and is very light weight. Easily adjustable at each 1 mcg division from 7 to 98 mcg / ml.</p>
          </div>
          <div class="col-md-1 col-xs-12"></div>
          <div class="col-xs-12">
            <a href="<?php echo base_url(); ?>contact_us" title="Know more about oxyzonetherapy" class="btn-plane center-block">Enquire Now</a>
          </div>
        </div>
      </div>
    </section>
    <section class="parallax-product-gwptwo">
      <div class="bgdark">
        <div class="container">
          <div class="row">
            <div class="col-md-1 col-xs-12"></div>
            <div class="col-md-10 col-xs-12">
              <h3 class="text-left text-uppercase h3-bold txt-fff">Features</h3>
              <hr class="hr-left" />
              <ul class="text-uppercase list-unstyled txt-fff">
                <li>Full Digital Display. </li>
                <li>Adjustment from 7 to 98 micrograms per ml.</li>
                <li>Self cooling type. Supported by timer.</li>
                <li>Ozone output is auto regulated by FQS and ACMT microprocessors inside.</li>
                <li>Calibration by latest technologies available.</li>
                <li>Exported all over the World.</li>
                <li>Admired for its heavy duty nature and easily programmable Light weight and portable.</li>
                <li>Economically priced in terms of the Global market.</li>
              </ul>
            </div>
            <div class="col-md-1 col-xs-12"></div>
          </div>
    ...
    <section class="">
      <div class="container">
        <div class="row">
          <div class="col-md-1 col-xs-12"></div>
          <div class="col-md-10 col-xs-12">
            <h3 class="text-left text-uppercase h3-bold">Technical Details</h3>
            <hr class="hr-left" />
            <ul class="text-uppercase list-unstyled">
              <li>Dimensions : 455X255X210 mm</li>
              <li>Weight : 10 Kg</li>
              <li>Medical Ozone : 5-95 micrograms per ml</li>
              <li>Noise : 48 decibels</li>
              <li>Power Consumption : 85 Watts</li>
              <li>Recommended Oxygen flow : 1-2 LPM</li>
              <li>No harmful by-products</li>
            </ul>
            <ul class="text-uppercase list-unstyled">
              <li>Dimensions : 300 mm x 265 mm x 100 mm</li>
              <li>Power Consumption : 7 Watts, 220 Volts, 50 Hz per 1000 mg/hr.</li>
              <li>Principle of operation : Dry Electrolysis</li>
              <li>Special Care : Very high frequency unit. Avoid operating near any other HF unit to avoid interference. Power supply line must have proper earthing.</dd>
              <li>Ozone Production : 7 to 98 micrograms per litre.</li>
              <li>Recommended feed : Medical grade oxygen</li>
              <li>Oxygen flow : 1 to 2 litres / min, dry and filtered.</li>
              <li>Safety : Electrically intrinsically safe. Not recommended for direct inhalation Should not be used continuously in a closed room. Should use
                the support of timer provided.</li>
              <li>Environmental Issue : >No harmful byproduct.</li>
              <li>Restriction : Not to be used with lid open.</li>
            </ul>
          </div>
          <div class="col-md-1 col-xs-12"></div>
        </div>
