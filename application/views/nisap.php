...
<html lang="en">
  ...
  <body>
      ...
      <div class="container">
        <div class="row">
          ...
          <div class="col-md-4 col-xs-12">
            <figure>
              <figcaption>NISA P</figcaption>
              <img class="img-responsive mid-block img-linux" src="https://ozonepedia.com/oxyzonetherapy/images/stories/mog%200016%20gw%20p.jpg"
              alt="MODEL-NISA–P" title="OXYZONE THERAPY HEALTHCARE PRODUCT MODEL NISA–P">
            </figure>
          </div>
          <div class="col-md-1 col-xs-12"></div>
          <div class="col-md-4 col-xs-12">
            <h3 class="text-left text-uppercase h3-bold prd-head">MODEL NISA–P</h3>
            <hr class="hr-ozone hr-left" />
            <p class="text-justify p-testimoni">This Analog product was the first Medical Ozone Generator to be ever made by an Indian research
              organization. It has been a historical product and is still upgraded every year since it is still purchased by senior medical practitioners
              globally. Vintage product - yielding modern success.</p>
          </div>
          <div class="col-md-1 col-xs-12"></div>
          <div class="col-xs-12">
    ...
    <section class="parallax-product-nisa">
      <div class="bgdark">
        <div class="container">
          <div class="row">
            <div class="col-md-1 col-xs-12"></div>
            <div class="col-md-10 col-xs-12">
              ...
              <ul class="text-uppercase list-unstyled txt-fff">
                ...
                <li>Ozone Regulation as per treatment : Continuous regulation in the range of 5-95 micrograms per ml (can be regulated by each microgram per ml)</li>
                <li>Can be used With / Without timer</li>
                <li>Functioning Indicators</li>
      ...
      <div class="container">
        <div class="row">
          <div class="col-sm-4 col-xs-12">
            <p class="hidden-xs text-left"></div>
          <div class="col-sm-4 col-xs-12">
